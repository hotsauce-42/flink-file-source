 ...
 *
 * <ul>
 *   <li>{@link OwnFileSource#forRecordStreamFormat(StreamFormat, Path...)}
 *   <li>{@link OwnFileSource#forBulkFileFormat(BulkFormat, Path...)}
 * </ul>
 *
 * <p>This creates a {@link OwnFileSource.FileSourceBuilder} on which you can configure all the
 ...
 * reading those.
 *
 * <p>When you start creating a file source (via the {@link OwnFileSource.FileSourceBuilder} created
 * through one of the above-mentioned methods) the source is by default in bounded/batch mode. Call
 * {@link OwnFileSource.FileSourceBuilder#monitorContinuously(Duration)} to put the source into
 ...
 */
@PublicEvolving
public final class OwnFileSource<T> extends OwnAbstractFileSource<T, FileSourceSplit>
