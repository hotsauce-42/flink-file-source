...
public abstract class OwnAbstractFileSource<T, SplitT extends FileSourceSplit>
  ...
  private SplitEnumerator<SplitT, PendingSplitsCheckpoint<SplitT>> createSplitEnumerator(
    ...
    long modificationTimeAlreadyProcessed = 0;
    ...
    if (continuousEnumerationSettings == null) {
      ...
      return castGeneric(
          new TimeBasedContinuousFileSplitEnumerator(
              fileSplitContext,
              enumerator,
              splitAssigner,
              inputPaths,
              modificationTimeAlreadyProcessed,
   ...
   */
  protected abstract static class OwnAbstractFileSourceBuilder<
      T,
      SplitT extends FileSourceSplit,
      SELF extends OwnAbstractFileSource.OwnAbstractFileSourceBuilder<T, SplitT, SELF>> {
    ...
    protected OwnAbstractFileSourceBuilder(
        final Path[] inputPaths,
        final BulkFormat<T, SplitT> readerFormat,
